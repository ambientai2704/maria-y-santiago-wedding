...
document.addEventListener('DOMContentLoaded', function () {
  ...
  ------------------------------------------------- */
  (function initIntro() {
    var intro = document.getElementById('cine-intro');
    var line1 = document.getElementById('cine-line-1');
    var line2 = document.getElementById('cine-line-2');
    ...
    setTimeout(function () { line1.classList.add('show'); }, 300);
    setTimeout(function () { line1.classList.remove('show'); }, 2600);
    setTimeout(function () { line2.classList.add('show'); }, 3200);
    setTimeout(function () { line2.classList.remove('show'); }, 5500);
